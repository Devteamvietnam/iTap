    ...
    let html = (
      <Form>
        <FormGroup label={T('Group Name')}>
          <BBStringField bean={attribute} field={'groupName'} disable={!writeCap} />
        </FormGroup>
        <FormGroup label={T('Name')}>
          <BBStringField bean={attribute} field={'name'} disable={!writeCap} />
        </FormGroup>
    ...
    return (
      <div className="flex-vbox">
        <FormGroup label={T('Label')}>
          <BBStringField bean={bean} field={'label'} disable={!this.hasWriteCapability() || !observer.isNewBean()} />
        </FormGroup>
