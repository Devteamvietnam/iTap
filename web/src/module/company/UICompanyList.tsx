...
class UICompanyListPageControl extends Component<VGridContextProps> {
  ...
  onNew() {
    ...
    let pageCtx = new app.PageContext(new widget.layout.DialogContext());
    let onPostCommit = () => {
      pageCtx.onBack();
      uiRoot.reloadData();
    }
    ...
    widget.layout.showDialog(T('New Company'), 'md', html, pageCtx.getDialogContext());
  }
