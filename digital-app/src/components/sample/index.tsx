  ...
  'server': {
    ...
    'components': {
      'rest-ping': {
        ...
        'view': (<server.rest.UIRestPing serverUrl={"http://localhost:8090/api/v1"} restPath={"/monitor/ping"} />)
      },
      'websocket-ping': {
        'label': "Websocket Echo",
        'description': "Demo UIWebsocketEcho Component",
        'view': (<server.websocket.UIWebsocketEcho serverUrl={"ws://localhost:8090"} wsPath={"/chat"} />)
      },
    }
  },
};
