package com.devteam.module.company.core.data.db.sample;
...
public class CompanyData  extends SampleData {
  ...
  protected void initialize(ClientInfo client) {
    ...
    TEST_COMPANY =
        new Company(TEST_COMPANY_CODE, "Test Company Inc")
            .withLoginAccountLoginId("admin")
            .withFullName("Test Company")
            .withDescription("Test Company")
            .withRegistrationCode("0313653099").withFoundingDate(DateUtil.parseCompactDate("12/08/2010"))
    ...
    DEMO_COMPANY =
        new Company(DEMO_COMPANY_CODE, "Demo Company Inc")
            ...
            .withRegistrationCode("0313653090")
