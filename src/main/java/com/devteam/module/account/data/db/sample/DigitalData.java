...
public class DigitalData extends AccountData {
  ...
  public void initialize(ClientInfo client) {
    ...
    RELATION_1 =
        new UserRelation()
          .withLabel("Xuan relation label 1")
          .withLoginId(PROFILE.getLoginId())
          .withFirstName("Nguyen")
          .withLastName("Hang").withRelation("daughter")
          .withBirthday(DateUtil.parseCompactDate("02/03/1995"))
          .withGender("female")
          .withFullName("Nguyen Thanh Hang")
            .withContact("+84123456788")
          .withNote("Sister");

    RELATION_2 =
        new UserRelation()
          .withLabel("Xuan relation label 2")
          .withLoginId(PROFILE.getLoginId())
          .withFirstName("Nguyen")
          .withLastName("Mai").withRelation("mother")
          .withBirthday(DateUtil.parseCompactDate("02/03/1960"))
          .withGender("female")
          .withFullName("Nguyen Thanh Mai")
    ...
    IDENTITY_1 = new UserIdentity().withLabel("Xuan identity label 1")
        .withLoginId(PROFILE.getLoginId()).withInfo("CMND", "Xuan Hoang", "258456987", "personal-id");

    IDENTITY_2 = new UserIdentity()
        .withLabel("Xuan identity label 2")
        .withLoginId(PROFILE.getLoginId())
    ...
    EDUCATION_1 = new UserEducation()
        .withLabel("Xuan education label 1")
        .withLoginId(PROFILE.getLoginId())
    ...
    EDUCATION_2 = new UserEducation()
        .withLabel("Xuan education label 2")
        .withLoginId(PROFILE.getLoginId())
