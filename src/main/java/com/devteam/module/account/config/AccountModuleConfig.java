...
import com.devteam.core.module.data.db.repository.DataTPRepositoryFactoryBean;
import com.devteam.core.module.http.config.CoreHttpModuleConfig;
import com.devteam.core.module.misc.ModuleCoreMiscConfig;
...
@Import(value = {
  ...
  StorageModuleConfig.class, ModuleCoreMiscConfig.class, CoreSecurityModuleConfig.class
})
