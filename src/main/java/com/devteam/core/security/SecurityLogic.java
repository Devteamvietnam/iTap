package com.devteam.core.security;
...
import com.devteam.core.data.query.*;
import com.devteam.core.security.entity.*;
import com.devteam.core.security.repository.AccessTokenRepository;
import com.devteam.core.security.repository.AppPermissonRepository;
import com.devteam.core.security.repository.AppRepository;
...
public class SecurityLogic extends DAOService {
  ...
  public List<AppPermission> findAppPermissions(ClientInfo client, String companyId, String loginId) {
  ...
  public boolean deletePermissionsByIds(ClientInfo client, List<String> ids) {
    for (String id : ids) {
  ...
  public List<AppAccessPermission> findPermissions(ClientInfo client, String companyId, AccessType accessType, String loginId) {
  ...
  public List<AppAccessPermission> searchPermissions(ClientInfo client, String companyId, SqlQueryParams params) {
  ...
  public List<AccessToken> searchAccessTokens(ClientInfo client, String companyId, SqlQueryParams params) {
    SqlQuery query =
        new SqlQuery().
