...
public class ClauseFilter {
  ...
  static public <T extends PersistableEntity<String>> ClauseFilter company(Class<T> entity) {
    return new ClauseFilter(entity, "companyId", "=", ":companyId");
  }
  
  static public <T extends PersistableEntity<String>> ClauseFilter companies(Class<T> entity) {
