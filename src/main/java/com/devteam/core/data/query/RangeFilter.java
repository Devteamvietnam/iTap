...
public class RangeFilter extends FieldFilter {
  ...
  static public <T extends PersistableEntity<String>> RangeFilter createdTime(Class<T> entity) {
    return new RangeFilter(entity,  "createdTime").type(FilterType.Date);
  }

  static public <T extends PersistableEntity<String>> RangeFilter modifiedTime(Class<T> entity) {
    return new RangeFilter(entity,  "modifiedTime").type(FilterType.Date);
  }

  static public <T extends PersistableEntity<String>> RangeFilter date(Class<T> entity, String field) {
