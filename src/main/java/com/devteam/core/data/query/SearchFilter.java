...
public class SearchFilter  {
  ...
  static public <T extends PersistableEntity<String>> SearchFilter isearch(Class<T> entityType, String ... fields) {
     SearchFilter search = new SearchFilter("search", entityType, fields, ILIKE_OP, "search");
     return search;
  }
  
  static public <T extends PersistableEntity<String>> SearchFilter isearch(String name, Class<T> entityType, String[] fields) {
    SearchFilter search = new SearchFilter(name, entityType, fields, ILIKE_OP, "search");
    return search;
 }

  static public <T extends PersistableEntity<String>> SearchFilter search(Class<T> entityType, String ... fields) {
