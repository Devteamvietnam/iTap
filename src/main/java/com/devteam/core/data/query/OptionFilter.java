...
public class OptionFilter extends FieldFilter {
  ...
  static public <T extends PersistableEntity<String>> OptionFilter storageState(Class<T> entity) {
    return new OptionFilter(entity, "storageState", "=", StorageState.ALL, StorageState.ACTIVE);
  }

  static public <T extends PersistableEntity<String>, O> OptionFilter create(Class<T> entity, String field, O[] options) {
