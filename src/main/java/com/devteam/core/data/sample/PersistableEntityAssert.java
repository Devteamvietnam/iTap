package com.devteam.core.data.sample;


import com.devteam.core.common.ClientInfo;
import com.devteam.core.data.db.entity.ChangeStorageStateRequest;
import com.devteam.core.data.db.entity.PersistableEntity;
import com.devteam.core.data.db.entity.StorageState;
...
public class PersistableEntityAssert<T extends PersistableEntity<String>> extends AssertTool {
  ...
  public ChangeStorageStateRequest createArchivedStorageRequest(PersistableEntity<String> entity) {
