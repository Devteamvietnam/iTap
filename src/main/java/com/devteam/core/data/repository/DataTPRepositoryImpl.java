...
@Slf4j
public class DataTPRepositoryImpl<T extends Persistable<ID>, ID
  extends Serializable> extends SimpleJpaRepository<T, ID>  
  implements DataTPRepository<T, ID> {
  
  private EntityManager              entityManager;
  private String                     entityName;

  public DataTPRepositoryImpl(Class<T> domainClass, EntityManager em) {
