package com.devteam.core.http.rest.v1.system;
...
import com.devteam.core.http.rest.monitor.JVMService;
import com.devteam.core.http.rest.monitor.JVMSummary;
import com.devteam.core.http.rest.monitor.RestCallMonitorService;
import com.devteam.core.http.rest.monitor.RestMonitor;
...
@Api(value="openfreightone", tags= {"core/monitor"})
@RestController
...
public class MonitorController extends BaseController {
  ...
  public @ResponseBody
  RestResponse ping(HttpSession session) {
