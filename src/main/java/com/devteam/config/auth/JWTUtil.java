package com.devteam.config.auth;
...
public class JWTUtil {
    private static final String CLAIM_FIRST_NAME_KEY = "ddthien";
    private static final String CLAIM_LAST_NAME_KEY = "code";
    ...
    public void setUpSecretKey() {
        try {
            ...
            log.error("Digital Error generating JWT Secret Key : {}", e.getMessage());
            throw new RuntimeException("Digital Error generating JWT Secret Key", e);
        }
    }
